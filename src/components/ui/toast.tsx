...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed right-0 top-0 z-[100] flex max-h-screen flex-col-reverse p-4 md:w-full md:max-w-[420px] sm:top-auto sm:flex-col",
      className
    )}
    {...props}
  />
