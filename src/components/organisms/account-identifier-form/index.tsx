...
const FormSchema = z
  .object({
    username: z.string().trim().min(1, { message: "Username is required" }).default(""),
    ...
    confirm: z.string().trim().min(6, "Confirm password is required").default(""),
  })
...
export default function AccountIdentifierForm() {
  ...
  return (
    <Card>
      ...
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="flex h-fit w-full flex-col gap-4">
            <FormField
            ...
            <p className="text-center text-sm text-foreground">
              ...
              <Link to="/log-in" className="font-semibold hover:text-primary/90">
                Log in
              </Link>
            </p>
          </form>
