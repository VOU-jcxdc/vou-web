...
const AuthenticatedAdminAdminInsightsRoute = AuthenticatedAdminAdminInsightsImport.update({
  path: "/adminInsights",
  getParentRoute: () => AuthenticatedAdminRoute,
} as any);

const AuthenticatedBrandEventsEventIdRoute = AuthenticatedBrandEventsEventIdImport.update({
  path: "/events/$eventId",
  getParentRoute: () => AuthenticatedBrandRoute,
} as any);

const AuthenticatedBrandEventsIndexRoute = AuthenticatedBrandEventsIndexImport.update({
  path: "/events/",
  getParentRoute: () => AuthenticatedBrandRoute,
} as any);

const AuthenticatedAdminUsersIndexRoute = AuthenticatedAdminUsersIndexImport.update({
  path: "/users/",
  getParentRoute: () => AuthenticatedAdminRoute,
} as any);

const AuthenticatedAdminGamesIndexRoute = AuthenticatedAdminGamesIndexImport.update({
  path: "/games/",
  getParentRoute: () => AuthenticatedAdminRoute,
} as any);

const AuthenticatedBrandEventsCreateRoute = AuthenticatedBrandEventsCreateImport.update({
  path: "/events/create",
  getParentRoute: () => AuthenticatedBrandRoute,
} as any);

const AuthenticatedAdminUsersUserIdRoute = AuthenticatedAdminUsersUserIdImport.update({
  path: "/users/$userId",
  getParentRoute: () => AuthenticatedAdminRoute,
} as any);

const AuthenticatedAdminGamesGameIdRoute = AuthenticatedAdminGamesGameIdImport.update({
  path: "/games/$gameId",
  getParentRoute: () => AuthenticatedAdminRoute,
} as any);
...
export const routeTree = rootRoute.addChildren({
  AuthenticatedRoute: AuthenticatedRoute.addChildren({
    ...
    AuthenticatedBrandRoute: AuthenticatedBrandRoute.addChildren({
      ...
      AuthenticatedBrandEventsEventIdRoute: AuthenticatedBrandEventsEventIdRoute.addChildren({
